  ...
  module V1
    class MissionsController < BaseController
      ...
      def ai_result_payload(result)
        ...
        rows_count = attrs["rows_count"].presence
        rows_count ||= attrs.dig("result_json", "rows_count")
        rows_count ||= result.mission&.expected_rows_count_from_uploads
        rows_count ||= attrs.dig("result_json", "shards_count")
