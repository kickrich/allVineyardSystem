...
/** Маркер «показ интерфейса тура»; не существует в данных приложения. */
export const TOUR_DEMO_DRONE_ID = -919191;

/**
 * Фиктивный дрон для панели во время тура: на карте «как размещён», маршрут из 3 точек,
 * позиция не у первой точки — видны подсказка и неактивная «Начать миссию».
 */
