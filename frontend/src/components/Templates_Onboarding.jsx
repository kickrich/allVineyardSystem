...
const STEPS = [
  {
    ...
    text:
      'Нажмите «Создать шаблон». Откроется карта с режимом редактирования маршрута: начертите зону и кликайте по карте, что бы построить маршрут.',
  },
  {
    id: 'tpl-start',
    target: 'tpl-start',
    title: 'Шаг 2. Вернуться к карте',
    text:
      'Вернёт вас к карте.',
  },
  {
