...
const STEPS = [
  ...
  },
  {
    ...
    text:
      'Блок «Управление полётом» и кнопка «Начать миссию» появляются, когда в маршруте не меньше двух точек. Сначала нажмите «К первой точке миссии» и дождитесь завершения подлёта — только после этого станет доступна кнопка «Начать миссию».',
  },
  {
